<?php 
 if(@$_GET['do']=='success'){
  ...
  $query = "SELECT * FROM tbl_oder INNER JOIN tbl_order_detail ON tbl_oder.order_id = tbl_order_detail.order_id ORDER BY order_status = 3" or die("Error:" . mysqli_error());
