            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-secondary mb-5">
                        ...
                        <br>
                        <div class="d-flex">
                            <img src="img/scb-icon.png" class="iconbank" width="50px" height="50px" ><p class="font-weight-semi eiei">ธนาคาร ไทยพาณิชย์ 816-257293-3 อรวรรณ</p>
                        </div>
                        <div class="card-body">
                            <input type="file" name="pay_slip" id="pay_slip" class="form-control" accept="image/*" onchange="readURL(this);"/>
